  ...
  <div class="login-wrap">
    <el-form class="login-container">
      ...
      <el-form-item label="账号">
        <el-input v-model="loginForm.username" placeholder="登录账号" autocomplete="off"></el-input>
      </el-form-item>
    ...
    methods: {
      ...
      login: function () {
        ...
        if (_this.loginForm.username === '' || _this.loginForm.password === '') {
          ...
          //这里是调用后端接口的地方
          //假设用户名密码是： name: "何欣娜小仙女", password: "5201314",则后端返回token:6688
          if (_this.loginForm.username == "何欣娜小仙女" && _this.loginForm.password == "5201314") {
            _this.userToken = 'SoulLogin_' + _this.loginForm.username + '_' + '6688';
            // 将用户token保存到vuex中
